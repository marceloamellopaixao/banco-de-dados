-- 1) Crie um bloco anomino que liste quantos funcion�rios trabalham na cidade de Toronto.
...
begin
    ...
    dbms_output.put_line('Trabalham em Toronto '||v_qtd||' funcion�rios.');
...
-- 2) Crie um bloco com as variaveis para realizar o insert na tabela Countries 
-- ( country_id=CL , country_name=Chile e Region_id=2 )
